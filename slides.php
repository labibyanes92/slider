...
class Slides extends Base_Widget {
	...
	public function get_title() {
		return __( 'Slider-labib', 'elementor-pro' );
	}
	...
	public function get_keywords() {
		return [ 'slides', 'carousel', 'image', 'title', 'slider','labib' ];
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'background_image',
			[
				'label' => _x( 'taswira', 'Background Control', 'elementor-pro' ),
		...
		$this->add_control(
			'slides',
			[
				'label' => __( 'Slideret', 'elementor-pro' ),
